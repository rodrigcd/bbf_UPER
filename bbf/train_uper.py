...
flags.DEFINE_string('priority_variable', 'default', 'Name of the priority variable.')
flags.DEFINE_string(
...
def main(unused_argv):
  ...
  create_agent_fn = functools.partial(
      create_agent, seed=seed, data_logging=FLAGS.data_logging, priority_variable=FLAGS.priority_variable)
  if FLAGS.max_episode_eval:
    ...
    print("Special Arguments:", kwargs)
